...
{{- $domain := include "global.domain" (list . (or .Values.global.ingress.customDomainPrefixes.csgshipAPI "csgship-api")) }}
{{- $domain -}}
{{- end }}
...
{{/*
Define if csgship enabled
*/}}
{{- define "csgship.enabled" -}}
{{- include "csghub.csgship.enabled" . -}}
{{- end }}
